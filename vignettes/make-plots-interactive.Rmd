...
description: >
  Learn how to make an interactive plot with psrpllot.
...
# Static Chart         
transit_access_chart<-interactive_column_chart(t=transit_access_df, 
...
You have a few options for saving an interactive chart. First you can right click on a plot you have open in R-Studio and save it to a file.

To export the static chart programmatically, you can use the htmlwidget package.

Here is how you can save the interactive bar chart you created above programmatically.
```{r}
library(htmlwidgets)
